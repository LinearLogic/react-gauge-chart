      ...
      <Container>
        ...
        <Row>
          ...
          <Col xs={12} lg={6}>
            ...
            <GaugeChart style={chartStyle} nrOfLevels={20} percent={0.86} needleColor='#345243' fontSize='12px' />
          </Col>
        </Row>
        <Row>
          <Col xs={12} lg={6}>
        ...
        <Row>
          <Col xs={12} lg={6}>
            ...
            <GaugeChart id='gauge-chart7' style={chartStyle} percent={currentPercent} animDelay={0} />
          </Col>
          <Col xs={12} lg={6}>
